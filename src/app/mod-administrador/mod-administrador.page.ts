...
@Component({
  selector: 'app-mod-administrador',
  templateUrl: './mod-administrador.page.html',
  styleUrls: ['./mod-administrador.page.scss'],
})
export class ModAdministradorPage implements OnInit {
