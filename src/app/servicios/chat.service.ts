...
import { Rol, Usuario } from '../clases/usuario.class';
...
export class ChatService {
  ...
  getMyChatrooms() {
    if (this.currentUser)
    return this.afs.collection('chatrooms', ref => ref.where('uids', 'array-contains', this.currentUser.uid).orderBy('updatedAt', 'desc')).valueChanges({ idField: 'id' }) as Observable<any>;
  }
  ...
  sexo: 'M', rol: Rol.Turista, imgurl: 'https://www.cambio16.com/wp-content/uploads/2017/11/michael-jackson-tv-show-joseph-fiennes.jpg' },
{ uid: 'gfvakYxGUpXDzs4o9tMDgbm8rbw1', nickname: 'madonna', passphrase: '12345678', nombre: 'Louise', apellido: 'Madonna', email: 'madonna@mail.com',
  sexo: 'F', rol: Rol.Turista, imgurl: 'https://www.lecturas.com/medio/2020/09/30/madonna_2ec43912_800x800.jpg' },
{ uid: 'Aj07lsjkMnPecxTCaPyVrXwzPtA3', nickname: 'freddy', passphrase: '12345678', nombre: 'Freddy', apellido: 'Mercury', email: 'freddy@mail.com',
  sexo: 'M', rol: Rol.Turista, imgurl: 'https://www.infobae.com/new-resizer/XpYTHbU4fzIIz-r25y5lkgs2XIA=/420x630/filters:format(jpg):quality(85)/cloudfront-us-east-1.images.arcpublishing.com/infobae/44NAV6FYPFFJDDVBGSTCCQ6PMY.jpg' },
{ uid: 'ptZBGiufbNVzcYohmJOtmUpEPiu2', nickname: 'whitney', passphrase: '12345678', nombre: 'Whitney', apellido: 'Huston', email: 'whitney@mail.com',
  sexo: 'F', rol: Rol.Turista, imgurl: 'https://www.infobae.com/new-resizer/rmG6gf7mexSjCRU59jHdQZQcvQw=/992x661/filters:format(jpg):quality(85)/arc-anglerfish-arc2-prod-infobae.s3.amazonaws.com/public/44CRQML4WJEAPNA5MNCMR4I4QI.jpg' },
{ uid: 'NOSED7e1U0S2YVXyhUjYJ8GRG7N2', nickname: 'elton', passphrase: '12345678', nombre: 'Elton', apellido: 'John', email: 'elton@mail.com',
  sexo: 'M', rol: Rol.Turista, imgurl: 'https://loff.it/wp-content/uploads/2017/03/loffit-elton-john-cantante-compositor-y-original-icono-del-pop-03-600x450-1616577881.jpg' },
{ uid: 'vAxXWcNetEOU9EmP9YrbSMJDJcI2', nickname: 'celine', passphrase: '12345678', nombre: 'Celine', apellido: 'Dion', email: 'celine@mail.com',
  sexo: 'F', rol: Rol.Turista, imgurl: 'https://resizer.glanacion.com/resizer/_Spsz8IVwi7-0vuYjRw2F_IhWMU=/768x0/filters:quality(100)/cloudfront-us-east-1.images.arcpublishing.com/lanacionar/QQV5XVWPNJH4NPRZE33HVGK42M.jpg' },
{ uid: 'OvBOZxu6zRflZMHWtCJYd62F8JW2', nickname: 'stevie', passphrase: '12345678', nombre: 'Stevie', apellido: 'Wonder', email: 'stevie@mail.com',
  sexo: 'M', rol: Rol.Turista, imgurl: 'https://los40es00.epimg.net/los40/imagenes/2020/05/13/los40classic/1589357730_131396_1589362585_rrss_normal.jpg' },
{ uid: 'iBXRD6E3tjT9DEjQteC9bxyAspM2', nickname: 'tina', passphrase: '12345678', nombre: 'Tina', apellido: 'Turner', email: 'tina@mail.com',
  sexo: 'F', rol: Rol.Turista, imgurl: 'https://los40es00.epimg.net/los40/imagenes/2018/11/22/los40classic/1542909340_729946_1542959141_noticia_normal.jpg' },
{ uid: 'sSVDvYmnSKSuzn3MwyNRYsZ1Mef1', nickname: 'bruce', passphrase: '12345678', nombre: 'Bruce', apellido: 'Springteen', email: 'bruce@mail.com',
  sexo: 'M', rol: Rol.Turista, imgurl: 'https://www.shemazing.net/wp-content/uploads/2016/10/screen-shot-2016-10-02-at-17-15-36.png' },
{ uid: 'bFOJqayOcKQRVCb4WdPOQdF8oRy2', nickname: 'cindy', passphrase: '12345678', nombre: 'Cindy', apellido: 'Louper', email: 'cindy@mail.com',
  sexo: 'F', rol: Rol.Turista, imgurl: 'https://www.rockandpop.cl/wp-content/uploads/2019/06/Cyndi-Lauper-400x360.jpg' }
];
}
